...
function Display() {
  ...
  return (
    <div className='overflow-auto container mt-4'>
      <h2 className='mb-4'>Recently Added Auctions</h2>
      <div className='row'>
          ...
          <div key={auction.id} className='col-md-4 mb-3'>
            <div className='card'>
              <div className='card-body'>
                ...
                <Link to={`/editauction/${auction.id}`} className='btn btn-primary'>
                  Edit Auction
                </Link>
                <Link to={`/deleteauction/${auction.id}`} className='btn btn-primary'>
                  Delete Auction
                </Link>
              </div>
            </div>
